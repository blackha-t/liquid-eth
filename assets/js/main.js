...
window.addEventListener("load", () => {
  ...
  async function toggleDynamicContent() {
    ...
    if (dynamicContent.style.display === "block") dynamicContent.style.display = "none";
	  ...
	  if(eligibility.value > 4001) newContent = " You are eligible to claim " + getEligibleAmount(eligibility.value) + " LiquidETH, which can be exchanged to Ethereum at 1:1 ratio."
